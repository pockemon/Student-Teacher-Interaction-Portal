      ...
      <ul class="links">
		...
		<!-- Two -->
			<section id="two" class="wrapper style2">
              ...
              <p> Here we have developed the a STIP(student-teacher interaction portal), which is generally used in the college to rate the faculty based on the performance.
